      ...
      <div class="container-fluid">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php 
					$sql = "SELECT * FROM sub_cat ORDER BY sub_cat_id DESC" ;
        ...
        <?php 
			if(isset($_POST['dactive'])){
				$id = $_POST['sub_cat_id'];
				$sql = "UPDATE sub_cat SET sub_status = '0' WHERE sub_cat_id = '$id'";
				$que = mysqli_query($con,$sql);
				if($que){
			...
			if(isset($_POST['active'])){
				$id = $_POST['sub_cat_id'];
				$sql = "UPDATE sub_cat SET sub_status = '1' WHERE sub_cat_id = '$id'";
				$que = mysqli_query($con,$sql);
				if($que){
